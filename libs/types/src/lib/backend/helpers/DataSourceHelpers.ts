...
export function updateDataSetLastPullDate(
  db: any,
  TABLE_NAME: string,
  dataViewID: string,
  user: string,
...
export function updateDataViewQueueStatus(
  db: any,
  TABLE_NAME: string,
  dataSetID: string,
...
export function updateDataSetQueueStatus(
  db: any,
  TABLE_NAME: string,
  dataViewID: string,
  status: DataSetQueueStatus,
...
export async function getDataCollectionTemplate(
  db: any,
  TABLE_NAME: string,
  collectionID: string,
): Promise<DataCollectionTemplate | undefined> {
  const getParams = {
    TableName: TABLE_NAME,
    Key: {
      type: "DataCollection",
